...
public class EllipticCurveJPAKEDemo {
    ...
    private void run () {
        ...
        System.out.println("X coord of G (" + G.normalize().getXCoord().toBigInteger().bitLength() + " bits): " + G.normalize().getXCoord().toBigInteger().toString(16));
        System.out.println("y coord of G (" + G.normalize().getYCoord().toBigInteger().bitLength() + " bits): " + G.normalize().getYCoord().toBigInteger().toString(16));
        ...
        BigInteger x1 = org.bouncycastle.util.BigIntegers.createRandomInRange(BigInteger.ZERO,
                n.subtract(BigInteger.ONE), new SecureRandom());
        BigInteger x2 = org.bouncycastle.util.BigIntegers.createRandomInRange(BigInteger.ZERO,
                n.subtract(BigInteger.ONE), new SecureRandom());
        ...
        ECPoint S1 = G.multiply(s1.mod(n));
        ECPoint S2 = G.multiply(s2.mod(n));
        ...
        BigInteger Ka = getSHA256( B.subtract(X4.multiply(x2.multiply(s1.mod(n)))).multiply(x2).normalize().getXCoord().toBigInteger());
        BigInteger Kb = getSHA256( A.subtract(X2.multiply(x4.multiply(s2.mod(n)))).multiply(x4).normalize().getXCoord().toBigInteger());
